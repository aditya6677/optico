		...
		<?php if ( have_posts() ) : ?>
			...
			while ( have_posts() ) : the_post();
				...
				if( themestek_get_option('blog_view') == 'box' ){
					...
					echo get_template_part('theme-parts/blogbox/blogbox','classic');
				}
				else if(themestek_get_option('blog_view') == 'classic-style2') {
					echo get_template_part('theme-parts/blogbox/blogbox','classic-style2');
				}
				else if(themestek_get_option('blog_view') == 'classic-style3') {
					echo get_template_part('theme-parts/blogbox/blogbox','classic-style3');
				}
				else {
					get_template_part( 'theme-parts/content', 'post' );
				}
