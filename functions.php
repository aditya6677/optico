<?php
/**
 * Optico functions and definitions
 *
...
if ( ! function_exists( 'optico_setup' ) ) :
/**
...
function optico_setup() {
	 ...
	 * If you're building a theme based on optico, use a find and replace
	 * to change 'optico' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'optico', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'themestek-main-menu'			=> esc_html__( 'Main Menu', 'optico' ),
		'themestek-footer-menu'			=> esc_html__( 'Footer Menu', 'optico' ),
		'themestek-topbar-left-menu'	=> esc_html__( 'Topbar Left Menu', 'optico' ),
		'themestek-topbar-right-menu'	=> esc_html__( 'Topbar Right Menu', 'optico' ),
	) );


}
endif; // optico_setup()
add_action( 'after_setup_theme', 'optico_setup' );
