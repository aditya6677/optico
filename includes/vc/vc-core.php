...
function ts_vcSetAsTheme() {
	...
	if( function_exists('vc_set_default_editor_post_types') ){
		vc_set_default_editor_post_types(array('page', 'ts-portfolio', 'ts-team-member'));
	}
}
...
class ts_VcSharedLibrary {
	...
	public static function ts_getColorsDashed() {
		$colors = array(
			...
			esc_attr__( 'Blue', 'optico' ) => 'blue',
			esc_attr__( 'Turquoise', 'optico' ) => 'turquoise',
			esc_attr__( 'Pink', 'optico' ) => 'pink',
			esc_attr__( 'Violet', 'optico' ) => 'violet',
			esc_attr__( 'Peacoc', 'optico' ) => 'peacoc',
			esc_attr__( 'Chino', 'optico' ) => 'chino',
			esc_attr__( 'Mulled Wine', 'optico' ) => 'mulled-wine',
			esc_attr__( 'Vista Blue', 'optico' ) => 'vista-blue',
			esc_attr__( 'Black', 'optico' ) => 'black',
			esc_attr__( 'Grey', 'optico' ) => 'grey',
			esc_attr__( 'Orange', 'optico' ) => 'orange',
			esc_attr__( 'Sky', 'optico' ) => 'sky',
			esc_attr__( 'Green', 'optico' ) => 'green',
			esc_attr__( 'Juicy pink', 'optico' ) => 'juicy-pink',
			esc_attr__( 'Sandy brown', 'optico' ) => 'sandy-brown',
			esc_attr__( 'Purple', 'optico' ) => 'purple',
			esc_attr__( 'White', 'optico' ) => 'white'
		);
...
$ts_pixel_icons = array(
	array( 'vc_pixel_icon vc_pixel_icon-alert' => esc_attr__( 'Alert', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-info' => esc_attr__( 'Info', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-tick' => esc_attr__( 'Tick', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-explanation' => esc_attr__( 'Explanation', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-address_book' => esc_attr__( 'Address book', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-alarm_clock' => esc_attr__( 'Alarm clock', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-anchor' => esc_attr__( 'Anchor', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-application_image' => esc_attr__( 'Application Image', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-arrow' => esc_attr__( 'Arrow', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-asterisk' => esc_attr__( 'Asterisk', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-hammer' => esc_attr__( 'Hammer', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-balloon' => esc_attr__( 'Balloon', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-balloon_buzz' => esc_attr__( 'Balloon Buzz', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-balloon_facebook' => esc_attr__( 'Balloon Facebook', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-balloon_twitter' => esc_attr__( 'Balloon Twitter', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-battery' => esc_attr__( 'Battery', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-binocular' => esc_attr__( 'Binocular', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_excel' => esc_attr__( 'Document Excel', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_image' => esc_attr__( 'Document Image', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_music' => esc_attr__( 'Document Music', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_office' => esc_attr__( 'Document Office', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_pdf' => esc_attr__( 'Document PDF', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_powerpoint' => esc_attr__( 'Document Powerpoint', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_word' => esc_attr__( 'Document Word', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-bookmark' => esc_attr__( 'Bookmark', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-camcorder' => esc_attr__( 'Camcorder', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-camera' => esc_attr__( 'Camera', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-chart' => esc_attr__( 'Chart', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-chart_pie' => esc_attr__( 'Chart pie', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-clock' => esc_attr__( 'Clock', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-fire' => esc_attr__( 'Fire', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-heart' => esc_attr__( 'Heart', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-mail' => esc_attr__( 'Mail', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-play' => esc_attr__( 'Play', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-shield' => esc_attr__( 'Shield', 'optico' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-video' => esc_attr__( 'Video', 'optico' ) ),
);
...
function ts_box_params($boxtype=''){
	...
	$boxview = array(
		esc_attr__('Row and Column','optico')  => 'default',
		esc_attr__('Carousel effect','optico') => 'carousel',
	);

	// CSS Animation
	$vc_map_add_css_animation = vc_map_add_css_animation();
	$vc_map_add_css_animation['group'] = esc_attr__( 'Boxes Appearance', 'optico' );
	...
	$boxOprions = array(
		...
		array(
			"type"        => "dropdown",
			"heading"     => esc_attr__("Column", "optico"),
			"param_name"  => "column",
			"description" => esc_attr__("Select column.", "optico"),
			"value"       => array(
				esc_attr__("One Column",    "optico") => "one",
				esc_attr__("Two Columns",   "optico") => "two",
				esc_attr__("Three Columns", "optico") => "three",
				esc_attr__("Four Columns",  "optico") => "four",
				esc_attr__("Five Columns",  "optico") => "five",
				esc_attr__("Six Columns",   "optico") => "six",
			),
		...
		array(
			...
			"holder"      => "div",
			"class"       => "",
			"heading"     => esc_attr__("Box View",'optico'),
			"description" => esc_attr__("Select box view. Show as normal row and column or show with carousel effect.",'optico'),
			"param_name"  => "boxview",
			"value"       => $boxview,
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Timeline: Group by', 'optico' ),
			'param_name' => 'timeline_groupby',
			'value'      => array(
				esc_attr__( 'Monthly grouping', 'optico' ) => 'monthly',
				esc_attr__( 'Yearly grouping', 'optico' )  => 'yearly'
			),
			'description' => esc_attr__( 'Timeline: Show timeline view in which group by.', 'optico' ),
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
			'dependency'  => array(
				'element'   => 'boxview',
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Timeline: Box view', 'optico' ),
			'param_name' => 'timeline_boxview',
			'value'      => array(
				esc_attr__( 'Simple view - without featured image', 'optico' ) => 'simple',
				esc_attr__( 'Simple view - with featured image', 'optico' )    => 'simple_with_fetured',
				esc_attr__( 'Box view', 'optico' )                             => 'box',
			),
			'description' => esc_attr__( 'Timeline: Show timeline view in which group by.', 'optico' ),
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
			'dependency'  => array(
		...
		array(
			'type'        => 'textfield',
			'heading'     => esc_attr__( 'Carousel: Transaction speed', 'optico' ),
			'param_name'  => 'carousel_speed',
			'description' => esc_attr__( 'Carousel Effect: Slide/Fade animation speed.', 'optico' ),
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
			'dependency'  => array(
				'element'   => 'boxview',
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: Autoplay', 'optico' ),
			'param_name' => 'carousel_autoplay',
			'value'      => array(
				esc_attr__( 'Yes', 'optico' ) => '1',
				esc_attr__( 'No', 'optico' )  => '0'
			),
			'description' => esc_attr__( 'Carousel Effect: Enable/disable Autoplay', 'optico' ),
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel', 'slickview','slickview-leftimg','slickview-bottomimg'),
		...
		array(
			'type'        => 'textfield',
			'heading'     => esc_attr__( 'Carousel: autoplaySpeed', 'optico' ),
			'param_name'  => 'carousel_autoplayspeed',
			'description' => esc_attr__( 'Carousel Effect: autoplay speed. Inert numbers only. Default value is "4500".', 'optico' ),
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel', 'slickview','slickview-leftimg','slickview-bottomimg'),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: Loop Item', 'optico' ),
			'param_name' => 'carousel_loop',
			'value'      => array(
				esc_attr__( 'No', 'optico' )  => '0',
				esc_attr__( 'Yes', 'optico' ) => '1',
			),
			'description' => esc_attr__( 'Carousel Effect: Infinite loop sliding.', 'optico' ).'<br><strong>'.esc_attr__( 'NOTE:', 'optico' ).' </strong> '.esc_attr__( 'If you select NO than the carousel will rewind all and start from 1st item. Also this will work if you enabled "Autoplay".', 'optico' ),
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel', 'slickview','slickview-leftimg','slickview-bottomimg'),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: dots', 'optico' ),
			...
			'description' => esc_attr__( 'Carousel Effect: Show dots navigation.', 'optico' ),
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel', 'slickview','slickview-leftimg','slickview-bottomimg'),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: Next/Prev Arrows', 'optico' ),
			'param_name' => 'carousel_nav',
			'value'      => array(
				esc_attr__('Above Carousel', 'optico')       => 'above',
				esc_attr__('Below Carousel', 'optico')       => 'below',
				esc_attr__('Before / After boxes', 'optico') => '1',
				esc_attr__('Hide', 'optico')                 => 'hide',
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: centerMode', 'optico' ),
			...
			'description' => esc_attr__( 'Enables centered view with partial prev/next slides. Use with odd numbered slidesToShow counts.', 'optico' ),
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel' ),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: pauseOnFocus', 'optico' ),
			'param_name' => 'carousel_pauseonfocus',
			'value'      => array(
				esc_attr__('Yes', 'optico') => '1',
				esc_attr__('No', 'optico')  => '0',
			),
			'description' => esc_attr__( 'Carousel Effect: Pause Autoplay On Focus.', 'optico' ),
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel' ),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: pauseOnHover', 'optico' ),
			'param_name' => 'carousel_pauseonhover',
			'value'      => array(
				esc_attr__('Yes', 'optico') => '1',
				esc_attr__('No', 'optico')  => '0',
			),
			'description' => esc_attr__( 'Carousel Effect: Pause on mouse hover.', 'optico' ),
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel' ),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: slidesToScroll', 'optico' ),
			'param_name' => 'carousel_slidestoscroll',
			'value'      => array(
				esc_attr__( '1 Slide', 'optico' )        => '1',
				esc_attr__( 'Same as column', 'optico' ) => 'column',
			),
			'description' => esc_attr__( '# of slides to scroll.', 'optico' ),
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel' ),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: Box transaction effect', 'optico' ),
			'param_name' => 'carousel_effecttype',
			'value'      => array(
				esc_attr__( 'Slide', 'optico' )  => 'slide',
				esc_attr__( 'fade', 'optico' )   => 'fade',
			),
			'description' => esc_attr__( 'Select Fade or Slide effect for carousel.', 'optico' ) . '<br><strong>' . esc_attr__( 'NOTE:', 'optico' ) . esc_attr__( 'The FADE effect will work with one column view only.', 'optico' ) . '</strong>',
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel', 'slickview','slickview-leftimg','slickview-bottomimg'),
		...
		array(
			...
			'param_name'  => 'el_class',
			'description' => esc_attr__( 'If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.', 'optico' ),
			'group'       => esc_attr__( 'Boxes Appearance', 'optico' ),
		),
	...
	$params = array_merge(
		array(
			array(
				...
				'param_name'  => 'h2',
				'save_always' => true,
				'value'       => esc_attr__( 'Welcome', 'optico' ),
		...
		array(
			array(
				...
				'description' => esc_attr__( 'Select text alignment.', 'optico' ),
				'std'         => 'left',
			),
		)
	);
...
function ts_responsive_padding_margin_option( $for=''){
	$return = array(
		...
		"heading"		=> esc_attr__("Responsive Padding/Margin Options", "optico"),
		"description"	=> esc_attr__("You can mange padding/margin from here. For differnt screen sizes", "optico"),
		"param_name"	=> "ts_responsive_css",
		'group'			=> esc_attr__( 'Responsive Padding/Margin Options', 'optico' ),
	);
...
function ts_vc_add_extra_param(){
	...
	vc_add_param( 'vc_row', array(
		...
		"value"       => array(
			...
			esc_attr__("Dark Color", "optico")  => "dark",
			esc_attr__("White Color", "optico") => "white",
			esc_attr__("Skin Color", "optico")  => "skincolor",
		),
	));
	...
	vc_add_param( 'vc_row', array(
		...
		"description" => esc_attr__("Select Background Color. If you select color and also select background Video or background Image than the color will be overlay with some opacity.", "optico"),
		"param_name"  => "ts_bgcolor",
		"weight"      => 1,
		"value"       => array(
			esc_attr__("Default (From Design Options tab)", "optico") => "",
			esc_attr__('Dark grey color as background color', 'optico') => 'darkgrey',
			esc_attr__('Grey color as background color', 'optico')      => 'grey',
			esc_attr__('White color as background color', 'optico')     => 'white',
			esc_attr__('Skincolor color as background color', 'optico') => 'skincolor',
	...
	vc_add_param( 'vc_row', array(
		"type"        => "dropdown",
		"heading"     => esc_attr__("Background Image Position", "optico"),
		"description" => esc_attr__("Select Background Image Position", "optico"),
		"param_name"  => "ts_bgimage_position",
		"weight"      => 1,
		"value"       => array(
			esc_attr__('left top', "optico")      => 'left_top',
			esc_attr__('left center', "optico")   => 'left_center',
			esc_attr__('left bottom', "optico")   => 'left_bottom',
			esc_attr__('right top', "optico")     => 'right_top',
			esc_attr__('right center', "optico")  => 'right_center',
			esc_attr__('right bottom', "optico")  => 'right_bottom',
			esc_attr__('center center', "optico") => 'center_center',
			esc_attr__('center top', "optico")    => 'center_top',
			esc_attr__('center bottom', "optico") => 'center_bottom'
		),
		"std"  => "center_center",
	));
	...
	vc_add_param( 'vc_column', array(
		"type"        => "dropdown",
		"heading"     => esc_attr__("Background Color", "optico"),
		"description" => esc_attr__("Select Background Color. If you select color and also select background Image than the color will be overlay with some opacity", "optico"),
		"param_name"  => "ts_bgcolor",
		"weight"      => 1,
		"value"       => array(
			esc_attr__("Default (From Design Options tab)", "optico") => "",
	...
	vc_add_param( 'vc_column', array(
		"type"        => "dropdown",
		"heading"     => esc_attr__("Add shadow?", "optico"),
		"description" => esc_attr__("Select YES to set shadow for the column.", "optico"),
	...
	vc_add_param( 'vc_column', array(
		"type"        => "dropdown",
		"heading"     => esc_attr__("Reduce spacing (Padding) from left/right area in responsive mode", "optico"),
		"description" => esc_attr__("This is useful if you set extra padding via 'Design Options' tab. This will reset spacing (padding) from left/right area for the column.", "optico"),
		"param_name"  => "reduce_extra_padding",
		"weight"      => 1,
		"value"       => array(
			esc_attr__("None (default)", "optico")                       		   => "",
			esc_attr__('Reset in small desktop (under 1200 pixel size)', "optico") => '1200',
			esc_attr__('Reset in tablet (under 992 pixel size)', "optico")         => '991',
		),
	));
	...
	vc_add_param( 'vc_column', array(
		"type"        => "dropdown",
		"heading"     => esc_attr__("Exapand Column Background", "optico"),
		"description" => esc_attr__("Exapand Column BG to left or right. This will expand the Background image/color visibility to border of the browser border.", "optico"),
		"param_name"  => "ts_col_bg_expand",
		"weight"      => 1,
		"value"       => array(
			esc_attr__("No expand (default)", "optico")                => "",
			esc_attr__('Exapand Column background to left', 'optico')  => 'left',
			esc_attr__('Exapand Column background to right', 'optico') => 'right',
		),
	));
	...
	vc_add_param( 'vc_row_inner', array(
		"type"        => "dropdown",
		"heading"     => esc_attr__("Break column in Responsive", "optico"),
		"description" => esc_attr__("Break columns (set in one row) in Desktop or Tablet screens. This is useful if your content breaks (or not fit) due to wider content in columns.", "optico"),
		"param_name"  => "break_in_responsive",
		"weight"      => 1,
		"value"       => array(
			esc_attr__("None (default)", "optico")									=> "",
			esc_attr__('Break in small desktop (under 1200 pixel size)', "optico")	=> '1200',
			esc_attr__('Break in tablet (under 992 pixel size)', "optico")			=> '991',
		),
	));
...
add_action( 'vc_after_init', 'ts_vc_add_extra_param' );
...
function themestek_vc_add_skin_color() {
	...
	foreach( $vc_element_array as $vc_element ){
		...
		if( is_array($colors) ){
			...
			$colors[__( '[Skin color]', 'optico' )] = 'skincolor';
		...
		foreach( $params as $key=>$param ){
			...
			if( isset($param['param_name']) && $param['param_name']=='i_type' ){
				...
				$libraries = array_merge(
					array( esc_attr__('Optico Special Icons','optico') => 'ts_optico' ),
					$param['value']
				);
				...
				// adding icon picker : ts_optico

				$new_params[] = array(
					'type'        => 'themestek_iconpicker',
					'heading'     => esc_attr__( 'Icon', 'optico' ),
					'param_name'  => 'i_icon_ts_optico',
