<?php
	...
	if( is_array($ts_global_fid_element_values) ) :
		...
		$data_fill		= ( !empty($ts_global_fid_element_values['data_fill']) ) ? $ts_global_fid_element_values['data_fill'] : '#fff' ;
		$data_emptyfill	= ( !empty($ts_global_fid_element_values['data_emptyfill']) ) ? $ts_global_fid_element_values['data_emptyfill'] : '#000301' ;
