<?php
	...
	if( is_array($ts_global_fid_element_values) ) :
		...
		$skincolor = ( !empty($optico_theme_options['skincolor']) ) ? $optico_theme_options['skincolor'] : '#78c63e' ;

		$data_fill		= ( !empty($ts_global_fid_element_values['data_fill']) ) ? $ts_global_fid_element_values['data_fill'] : $skincolor ;
		$data_emptyfill	= ( !empty($ts_global_fid_element_values['data_emptyfill']) ) ? $ts_global_fid_element_values['data_emptyfill'] : '#000005' ;
...
<div class="ts-fid inside ts-fid-boxstyle-style1 <?php echo themestek_sanitize_html_classes($ts_global_fid_element_values['main-class']); ?>">
	...
	<div class="ts-fld-contents">
		<div class="ts-circle-outer"
			...
			data-fill			= "<?php echo esc_attr($data_fill); ?>"
			...
			data-size			= "122"
			data-emptyfill		= "<?php echo esc_attr($data_emptyfill); ?>"
			data-thickness		= "7"
			data-gradient		= ""
			>
